...
- `references/chain-enforcement-integration.md` — how skill_enhance.py uses loop-enforcer to lock 11-step pipeline

### Lessons (`references/lessons/`)

- `references/chain-enforcement-integration.md` — how skill-creator uses loop-enforcer to lock the 11-step pipeline
