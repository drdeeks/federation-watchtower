/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9f9295353393f6e65eb9eb29faaaf907)
// Runtime types generated with workerd@1.20260714.1 2026-07-17 nodejs_compat
interface __BaseEnv_Env {
	VAULT: R2Bucket;
	DB: D1Database;
	WATCHTOWER_ALERTS: Queue;
	ASSETS: Fetcher;
	ENVIRONMENT: "production";
	WATCHTOWER_INGESTION_SECRET: string;
	WATCHTOWER_ADMIN_TOKEN: string;
	AGENT_REGISTRY: DurableObjectNamespace<import("./src/index").AgentRegistry>;
	FEDERATION_COORDINATOR: DurableObjectNamespace<import("./src/index").FederationCoordinator>;
	PROJECT_GUARDRAIL: DurableObjectNamespace<import("./src/index").ProjectGuardrail>;
	AGENT_WATCHDOG: DurableObjectNamespace<import("./src/index").AgentWatchdog>;
	ROOM_SCENE: DurableObjectNamespace<import("./src/index").RoomScene>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AgentRegistry" | "FederationCoordinator" | "ProjectGuardrail" | "AgentWatchdog" | "RoomScene";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "WATCHTOWER_INGESTION_SECRET" | "WATCHTOWER_ADMIN_TOKEN">> {}
}
